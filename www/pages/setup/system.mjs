...
template.innerHTML = `
  ...
  <action-bar>
      ...
      <action-bar-item id="sources-btn">File Sources</action-bar-item>
  </action-bar>
  ...
  <div id="container">
    ...
    <div id="group-flags" class="group">
      ...
      <field-component label="Forum updater"><input type="checkbox" id="flag-forumupdater"></input></field-component>
      <field-component label="Changeset updater"><input type="checkbox" id="flag-changesetupdater"></input></field-component>
      <field-component label="VSTS updater"><input type="checkbox" id="flag-vstsupdater"></input></field-component>
    </div>
...
class Element extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.getElementById("sources-btn").addEventListener("click", () => goto("/filesources"))

    this.refreshData();
  }

  async save(){
    await api.patch("system/setup", {
      ...
      flags:{
        ...
        forumUpdater: this.shadowRoot.getElementById("flag-forumupdater").checked ? true : false,
        changesetUpdater: this.shadowRoot.getElementById("flag-changesetupdater").checked ? true : false,
        vstsUpdater: this.shadowRoot.getElementById("flag-vstsupdater").checked ? true : false,
      }
    })
  ...
  async refreshData(){
    ...
    try{
      ...
      this.shadowRoot.getElementById("flag-forumupdater").checked = system.flags.forumUpdater;
      this.shadowRoot.getElementById("flag-changesetupdater").checked = system.flags.changesetUpdater;
      this.shadowRoot.getElementById("flag-vstsupdater").checked = system.flags.vstsUpdater;
      ...
      console.log(err)
      alertDialog("could not retrive system")
      return;
    }
  }
